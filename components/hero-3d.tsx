...
export function Hero3D() {
  ...
  return (
    <section
      ref={containerRef}
      className="lg:min-h-screen h-[90vh] pt-7 pb-6 flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 relative overflow-x-hidden"
    >
